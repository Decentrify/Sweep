...
// */
//public class SearchDescriptorSerializerOld implements Serializer<SearchDescriptor>{
//
//    private Logger logger = LoggerFactory.getLogger(SearchDescriptorSerializerOld.class);
//    @Override
