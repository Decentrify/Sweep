...
public class FlashCrowdMainTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" Starting the Convergence Scenario with" + " seed: " + seed + " throughput: " + throughput + " entries: " + numEntries + " initialClusterSize: " + initialClusterSize + " flashCrowdSize" + flashCrowdSize);
