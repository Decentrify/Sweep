...
import se.sics.ms.scenarios.special.BasicShardingScenario;
...
public class ShardAndSearchTest {
    ...
    public static void main(String[] args) {
        ...
        ShardingAndSearchScenario.boot(seed, depth, bucketSize, throughput, numEntries).simulate(LauncherComp.class);
    }
