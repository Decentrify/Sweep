...
public final class SearchPeerUpdated extends ComponentDefinition {

    private static final Logger log = LoggerFactory.getLogger(SearchPeerUpdated.class);
    ...
    public SearchPeerUpdated(SearchPeerInitUpdated init) throws NoSuchAlgorithmException {
