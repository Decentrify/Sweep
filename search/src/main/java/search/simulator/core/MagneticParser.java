...
/**
 * Parser for an xml string describing a magnetic link from the pirate bay. Some
 * xml files entries need to be prepared to be read by this parser because they
 * include invalid characters.
 */
public class MagneticParser {
	 ...
	 * @throws SAXException
	 */
	public MagneticParser() throws ParserConfigurationException, SAXException {
