...
public class UtilTests {
    ...
    public void determineYourPartitionTest() {
        ...
        boolean partition1 = PartitionHelper.determineAndChangeYourPartition(1, partitionId, true);
        assert (partition1);

        boolean partition2 = PartitionHelper.determineAndChangeYourPartition(2, partitionId, true);
        assert (!partition2);
