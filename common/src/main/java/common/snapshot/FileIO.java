...
public class FileIO {
	 ...
	 * 
	 * @param str
	 *            Specifies the string that should be written into file.
	 * @param fileName
	 *            Specifies the name of storing file.
	 * @throws IOException
	 *             Thrown if it can not open the file or write in it.
	 */
	 ...
	 *            Specifies the name of storing file.
	 * @throws IOException
	 *             Thrown if it can not open the file or append the content at
	 *             the of file.
	 */
