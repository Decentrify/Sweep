...
public final class CyclonConfiguration {
	...
	public CyclonConfiguration(long seed, int shuffleLength, int randomViewSize,
			long shufflePeriod, long shuffleTimeout, Long identifierSpaceSize,
			int bootstrapRequestPeerCount) {
		super();
		this.seed = seed;
	...
	public static CyclonConfiguration load(String file) throws IOException {
		...
		return new CyclonConfiguration(seed, shuffleLength, randomViewSize, shufflePeriod,
